...
const Stage3Camera = ({navigation}: {navigation: any}) => {
  ...
  useEffect(() => {
    console.log('Stage3Camera log - Department:', department);
    console.log('Stage3Camera log - College:', college);
  }, []);
  ...
  const goToNextStage = () => {
    navigation.navigate('Stage5', {college, department}); // ✅ Stage1_2로 이동
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate('Stage5', {college, department})}
