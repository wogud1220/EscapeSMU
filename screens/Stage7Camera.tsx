...
// //     const route = useRoute<RouteProp<RootStackParamList, 'Stage7Camera'>>();
...
// //   const goToNextStage = () => {
// //     navigation.navigate('Stage7_7', {department});
// //   };
...
//   useEffect(() => {
//     console.log('Stage7Camera log - Department:', department);
//     console.log('Stage7Camera log - College:', college);
//   }, []);
...
//       if (data.result === 'Pass') {
//         updateStageData(userId, college, 'Stage7_7');
...
//   }
//   const goToNextStage = () => {
//     navigation.navigate('Stage7_7', {college, department}); // ✅ Stage7_7로 이동
//   };
...
//       <TouchableOpacity
//         onPress={() => navigation.navigate('Stage7_7', {college, department})}
