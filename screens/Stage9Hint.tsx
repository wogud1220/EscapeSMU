...
const Stage9Hint = () => {
  ...
  const route = useRoute<RouteProp<RootStackParamList, 'Stage9Hint'>>();
  ...
  const handleNextStage = () => {
    navigation.navigate('Stage9_4', {college, department}); // ✅ Stage2_2으로 이동하도록 수정
  };
