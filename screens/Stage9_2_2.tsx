...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'Stage9_2_2'>;
  ...
  const handleOptionPress = (value: number) => {
    ...
    if (value === 4) {
      Alert.alert('정답입니다!', '다음 스테이지로 이동합니다.', [
        { text: '확인', onPress: () => navigation.navigate('Stage9_3', {department}) },
      ]);
    } else {
      ...
      >
        ...
        <View style={styles.box}>
          <Text style={styles.text}>
            그 옆에 디자인 대학 사용법이 있어!{'\n'}
            <Text style={styles.subText}>디자인놀이터, 디자인GOGO장, 디자인모임터</Text>의 {'\n'}사용 우선순위로 옳지 <Text style={styles.highlight}>않은</Text> 것은 무엇일까?
          </Text>
