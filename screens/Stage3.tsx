...
const Stage3 = () => {
  ...
  const route = useRoute<RouteProp<RootStackParamList, 'Stage3'>>();
  ...
  const handleNextStage = () => {
    navigation.navigate('Stage3_1', {college, department}); // ✅ Stage3_1로
  };
      ...
      <ImageBackground
        ...
        <View style={styles.box}>
          ...
          <CustomText style={{fontSize: 25, textAlign: 'center'}}>
            다음으로 방문할 장소는 식물과학관이야!
          </CustomText>
          <CustomText style={styles.subText}>안으로 한 번 들어가보자!</CustomText>
        </View>
