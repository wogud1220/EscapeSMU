...
const Stage12Camera_2 = ({ navigation }: { navigation: any }) => {
  const [device, setDevice] = useState<CameraDevice | undefined>();
  const camera = useRef<Camera>(null);
  const route = useRoute<RouteProp<RootStackParamList, 'Stage12Camera_2'>>();
  ...
  const goToNextStage = () => {
    navigation.navigate('Stage12_6', {department});
  };
...
export default Stage12Camera_2;
