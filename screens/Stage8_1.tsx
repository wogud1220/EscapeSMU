...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'Stage8_1'>;

const {width, height} = Dimensions.get('window');

const Stage8_1 = () => {
  useEffect(() => {
    console.log('Stage8 log - Department:', department);
    console.log('Stage8 log - College:', college);
  }, []);
  const navigation = useNavigation<NavigationProp>();
  const route = useRoute<RouteProp<RootStackParamList, 'Stage8_1'>>();
  ...
  const handleNextStage = () => {
    navigation.navigate('Stage8_2', {college, department}); // ✅ Stage8_1 가즈아
  };
...
const styles = StyleSheet.create({
  ...
  wayImage: {
    ...
    marginTop: height * 0.05, // ✅ 이미지와 텍스트 간격
  },
  dokdoImage: {
